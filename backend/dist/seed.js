...
const Item_1 = __importDefault(require("./models/Item")); // This imports the model we created earlier
// Load your .env file so we can connect to MongoDB
...
const seedDatabase = async () => {
    try {
        ...
        // 1. Clear out any old dummy data to start fresh
        console.log("🧹 Clearing old items...");
        await Item_1.default.deleteMany({});
        // 2. Insert our 20 beautiful new items
